...
public class Hurtownia {
    ...
    public ArrayList<Integer> getCenyTowarow() {
        return cenyTowarow;
    }
    ...
    public void dodajTowar(String towar, int cenaTowaru, int ilosc){
    ...
    public void sprzedajTowar(String towar, int ilosc){
        for(int i = 0; i < this.towary.size(); i++)
        {
        ...
        System.out.println("Stan konta hurtowni to: " + this.getStanKonta());
    }
